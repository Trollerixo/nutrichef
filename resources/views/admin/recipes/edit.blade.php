<x-app-layout>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.recetas.update', $recipe) }}" method="POST" enctype="multipart/form-data" onsubmit="this.querySelector('button[type=submit]').classList.add('btn-loading');">
                @csrf
                @method('PUT')
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-3">
                        ...
                        <input id="proteins_g" name="nutrition[proteins_g]" type="number" step="0.1" min="0" class="form-control @error('nutrition.proteins_g') is-invalid @enderror" value="{{ old('nutrition.proteins_g', $recipe->nutrition?->proteins_g) }}">
                    ...
                    <div class="col-md-3">
                        ...
                        <input id="carbs_g" name="nutrition[carbs_g]" type="number" step="0.1" min="0" class="form-control @error('nutrition.carbs_g') is-invalid @enderror" value="{{ old('nutrition.carbs_g', $recipe->nutrition?->carbs_g) }}">
                    ...
                    <div class="col-md-3">
                        ...
                        <input id="fats_g" name="nutrition[fats_g]" type="number" step="0.1" min="0" class="form-control @error('nutrition.fats_g') is-invalid @enderror" value="{{ old('nutrition.fats_g', $recipe->nutrition?->fats_g) }}">
                    ...
                    <div class="col-md-3">
                        ...
                        <input id="fiber_g" name="nutrition[fiber_g]" type="number" step="0.1" min="0" class="form-control @error('nutrition.fiber_g') is-invalid @enderror" value="{{ old('nutrition.fiber_g', $recipe->nutrition?->fiber_g) }}">
                ...
                <img src="{{ asset('images/icons/guardar_receta.svg') }}" alt="" class="nc-icon me-1">Guardar cambios
                </button>
            </form>
        </div>
    </div>
